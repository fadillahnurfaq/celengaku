...
class WishModelAdapter extends TypeAdapter<WishModel> {
  ...
  WishModel read(BinaryReader reader) {
    ...
    return WishModel(
      ...
      listSaving: (fields[5] as List).cast<SavingModel>(),
...
WishModel _$WishModelFromJson(Map<String, dynamic> json) => WishModel(
...
Map<String, dynamic> _$WishModelToJson(WishModel instance) => <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
